            ...
            <div className="pt-2 space-y-3">
              {directWaLink && (
                <a
                  ...
                  className="w-full h-11 inline-flex items-center justify-center gap-2 rounded-full bg-[#ffd233] hover:bg-[#f5c71a] text-black font-bold text-xs shadow-xs transition-all"
                >
